      ...
      <main className="z-10 flex flex-1 flex-col items-center justify-center gap-12 p-4 text-white md:relative">
        <section className="w-full max-w-5xl pt-8 text-center">
          <div className="rounded-2xl bg-slate-800/20 p-8 shadow-xl">
            ...
            <h1 className="mb-4 text-5xl font-bold">{dict.pages.services.services.immigrationMedicalExams.title}</h1>
            ...
            <div>
              ...
              <div className="flex justify-center">
                <Link href={IMMIGRATION_FAQ_URL} target="_blank">
                  <Button
                    size="lg"
                    className="mt-8 cursor-pointer bg-blue-300 font-bold text-black transition-colors duration-200 hover:bg-blue-300/80"
                  >
                    <MessageCircleQuestionMarkIcon />
